document.addEventListener('DOMContentLoaded', function() {
    ...
    if (animatedElements.length > 0) {
        ...
        // Handle RTL for fade-in-left and fade-in-right
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ac78032c-cfdd-4111-9b0f-c706456e6c8e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ac78032c-cfdd-4111-9b0f-c706456e6c8e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ac78032c-cfdd-4111-9b0f-c706456e6c8e';
